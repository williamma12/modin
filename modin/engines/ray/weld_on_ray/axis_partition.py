...
class WeldOnRayAxisPartition(BaseAxisPartition):
    ...
    def apply(self, func, num_splits=None, other_axis_partition=None, **kwargs):
        ...
        Args:
            ...
            other_axis_partition: Another `WeldOnRayAxisPartition` object to apply to
                func with this one.
...
class WeldOnRayColumnPartition(WeldOnRayAxisPartition):
...
class WeldOnRayRowPartition(WeldOnRayAxisPartition):
